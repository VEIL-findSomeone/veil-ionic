...
import { IonSpinner, IonToolbar, IonButtons, IonButton, IonIcon, IonInput } from '@ionic/react';
...
const GiphySearch: React.FC<Props> = ({ onSelect, onClose }) => {
  ...
  const getTrending = () => {
    ...
    GiphyService.trending().then(res => {
  ...
  return (
    <div className="giphy-search">
      <div className="giphy-container">
        ...
        {!isLoading && gifs.length === 0 && <div className="no-result">No GIF found</div>}
        {!isLoading && (
